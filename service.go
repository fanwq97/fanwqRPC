...
import (
	...
	"github.com/fanwq97/fanwqRPC/codec"
	"github.com/fanwq97/fanwqRPC/codes"
	"github.com/fanwq97/fanwqRPC/interceptor"
	"github.com/fanwq97/fanwqRPC/log"
	"github.com/fanwq97/fanwqRPC/metadata"
	"github.com/fanwq97/fanwqRPC/protocol"
	"github.com/fanwq97/fanwqRPC/transport"
	"github.com/fanwq97/fanwqRPC/utils"
...
type Service interface {
	Register(string, Handler)     // Register （处理函数 Handler 的注册）、
	Serve(options *ServerOptions) // 提供服务 Serve
	Close()                       // 服务关闭 Close 等方法
	Name() string
}
